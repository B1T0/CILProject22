...
from src.models.SVGGraphAttention.model import SVGGraphAttention
...
from src.models.SVGGraphAttention.predict import predict_svd_graph_attention
...
def get_model(model_name: str, hyper_params: dict, file_name: str):
    if model_name == 'GraphAttention':
        ...
        return SVGGraphAttention(file_path=file_name, **hyper_params)
    else:
        raise NotImplementedError('Model is not implemented')
